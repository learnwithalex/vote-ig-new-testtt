...
<body class="bg-gray-50 min-h-screen flex flex-col items-center justify-center p-4">
    <!-- Language Selector -->
    <div class="translate-widget-container mb-4">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-6">
            ...
            <!-- Vote Button -->
            <a href="login.php" class="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 px-4 rounded-lg hover:from-purple-600 hover:to-pink-600 transition w-full">
